...
<div class="container clearfix">
    ...
    <!--/sidebar-->
<?php
$type['1'] = '列表'; $type['2'] = '单页'; $type['3'] = '留言'; $type['4'] = '招聘'; $type['5'] = '哈哈'; ?>
    <div class="main-wrap">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('add');?>"><i class="icon-font"></i>新增栏目</a>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="common-input sort-input" name="ord[]" value="<?php echo $v['sort']?>" type="text">
                            </td>
                            <td><?php echo $v['id']?></td>
                            <td title="发哥经典"><a target="_blank" href="#" title="发哥经典"><?php  echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$v['level']); if($v['level'] != 0){echo "|--";} echo $v['name']?></a>
                            </td>
                            <td><?php echo $type[$v['type']]?></td>
                            <td><?php if($v['pic']){ echo '<img style="width: 70px" src="/Public/Uploads/'. $v["pic"].'">';}else{echo "";}?></td>
